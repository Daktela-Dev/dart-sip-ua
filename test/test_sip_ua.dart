...
void main() {
  test(' WebSocket: EchoTest', () async {
    ...
    configuration.sockets = <SIPUASocketInterface>[SIPUAWebSocket('ws://127.0.0.1:5070/sip', messageDelay: 0)];
    ...
    try {
      ...
      ua.on<EventSocketConnected>(EventSocketConnected, (EventSocketConnected data) {
        print('connected => $data');
      });

      ua.on<EventSocketDisconnected>(EventSocketDisconnected, (EventSocketDisconnected data) {
